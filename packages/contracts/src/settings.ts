...
import { ReadAloudSettings, ReadAloudSettingsPatch } from "./readAloud.ts";
...
export const ClientSettingsSchema = Schema.Struct({
  ...
  /**
   * Keep the timeline pinned to the newest output while a turn streams. Off
   * means the view never moves on its own — scroll position is yours alone.
   */
  followTimelineLiveEdge: Schema.Boolean.pipe(Schema.withDecodingDefault(Effect.succeed(true))),
...
export const ServerSettings = Schema.Struct({
  ...
  readAloud: ReadAloudSettings.pipe(Schema.withDecodingDefault(Effect.succeed({}))),
...
export const ServerSettingsPatch = Schema.Struct({
  ...
  readAloud: Schema.optionalKey(ReadAloudSettingsPatch),
...
export const ClientSettingsPatch = Schema.Struct({
  ...
  followTimelineLiveEdge: Schema.optionalKey(Schema.Boolean),
