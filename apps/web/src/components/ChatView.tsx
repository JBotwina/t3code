...
function ChatViewContent(props: ChatViewProps) {
  ...
  useEffect(() => {
    ...
    // issued by positionAnchor when the row mounts, not by this effect, which
    // only ever reveals the streaming reply.
  ...
  }, [activeThread?.id, followTimelineLiveEdge, timelineEntries, getActiveTimelineTurnMetrics]);
  ...
  const rightPanelContent = activeThreadRef ? (
    activeRightPanelSurface?.kind === "chat" ? (
      <SideChatPanel
        ...
        {...(activeRightPanelSurface.quote ? { quote: activeRightPanelSurface.quote } : {})}
          ...
          <div className="relative flex min-h-0 min-w-0 flex-1 flex-col">
            ...
            <div className="relative flex min-h-0 flex-1 flex-col" ref={timelineContainerRef}>
              ...
              <MessagesTimeline
                ...
                liveFollowEnabled={followTimelineLiveEdge && timelineLiveFollowEnabled}
