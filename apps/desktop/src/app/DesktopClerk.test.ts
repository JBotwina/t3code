...
const makeDesktopClerkLayer = (isDevelopment = true, events: string[] = []) => {
  const environment = DesktopEnvironment.DesktopEnvironment.of({
    ...
    userDataDirName: isDevelopment ? FORK_BRAND.userDataDirNameDev : FORK_BRAND.userDataDirName,
    legacyUserDataDirName: isDevelopment
      ? `${FORK_BRAND.baseName} (Dev)`
      : `${FORK_BRAND.baseName} (Alpha)`,
...
describe("DesktopClerk", () => {
  ...
  it.effect("acquires and releases the SDK bridge with the layer", () => {
    ...
    return Effect.gen(function* () {
        ...
        [
          {
            ...
            passkeys: true,
            renderer: { scheme: `${FORK_BRAND.schemeDev}`, host: "app" },
          },
        ],
      ]);
      ...
      assert.deepEqual(events, [
        `setPath:userData:/tmp/app-data/${FORK_BRAND.userDataDirNameDev}`,
        "createClerkBridge",
      ]);
  ...
  it.each([
    { isDevelopment: true, scheme: `${FORK_BRAND.schemeDev}` },
    { isDevelopment: false, scheme: `${FORK_BRAND.scheme}` },
